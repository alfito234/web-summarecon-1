                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="product-item">
                            <a class="product-link" href="{{ asset('/register') }}">
                                <div class="product-hover">
                                    <div class="product-hover-content">
                                        <i class="fas fa-plus fa-3x"></i>
                                    </div>
                                </div>
                                <img class="img-fluid" src="assets/img/product/summarecon.jpg" alt="..." />
                            </a>
                            <div class="product-caption">
                                <div class="product-caption-heading">Summarecon</div>
                    ...
                    {{-- <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-caption">
                                <div class="product-caption-heading">Explore</div>
                                <div class="product-caption-subheading text-muted">
                                    Graphic Design
                                </div>
                            </div>
                    ...
                    {{-- <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-caption">
                                <div class="product-caption-heading">Finish</div>
                                <div class="product-caption-subheading text-muted">
                                    Identity
                                </div>
                            </div>
                    ...
                    {{-- <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-caption">
                                <div class="product-caption-heading">Lines</div>
                                <div class="product-caption-subheading text-muted">
                                    Branding
                                </div>
                            </div>
                    ...
                    {{-- <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-caption">
                                <div class="product-caption-heading">Southwest</div>
                                <div class="product-caption-subheading text-muted">
                                    Website Design
                                </div>
                            </div>
                    ...
                    {{-- <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-caption">
                                <div class="product-caption-heading">Window</div>
                                <div class="product-caption-subheading text-muted">
                                    Photography
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row d-flex justify-content-center align-items-center">
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="https://www.summarecon.com/"><img class="img-fluid img-brand d-block mx-auto"
                                src="assets/img/logos/summarecon-logo.png" alt="..."
                                aria-label="Summarecon Logo" /></a>
                    </div>
                </div>
            </div>
        </div>
